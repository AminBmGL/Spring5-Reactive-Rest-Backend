...
import insat.amin.restapireactive.repositories.CategoryRepository;
...
public class CategoryControllerTest {
    ...
    public void TestUpdate() {
        ...
        Mono<Category> toUpdateMono = Mono.just(Category.builder().description("Some desc").build());

        webTestClient.put()
                .uri("/api/v1/categories/blab")
                .body(toUpdateMono, Category.class)
                .exchange()
                .expectStatus()
                .isOk();
    }
